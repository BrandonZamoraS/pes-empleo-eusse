...
export default function LoginContent({ authError, returnUrl }: LoginContentProps) {
      ...
      <div className="flex-1">
        ...
        <div className="mt-7 space-y-4">
          <button
            ...
            disabled={isPending}
            className="flex w-full items-center justify-center gap-2 rounded-2xl border border-transparent bg-brand-50 px-4 py-3 text-sm font-semibold text-brand-900 shadow-[0_18px_45px_rgba(0,0,0,0.08)] transition hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-50"
          >
